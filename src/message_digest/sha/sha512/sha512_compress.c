...
/*   Updated: 2019/03/08 15:46:50 by fhuang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (right_rotate_64(value, 28)
				^ right_rotate_64(value, 34)
				^ right_rotate_64(value, 39));
}

static uint64_t	sum_1(uint64_t value)
{
	return (right_rotate_64(value, 14)
			^ right_rotate_64(value, 18)
			^ right_rotate_64(value, 41));
}
